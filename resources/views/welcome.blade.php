            ...
            <div class="swiper">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="#">
                            <img src="/assets/slid3.JPG" alt="..." class="w-full img-slide">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="#">
                            <img src="/img/gambar2.jpg" alt="..." class="w-full img-slide">
                        </a>
                    </div>
                </div>
    ...
    <div class="isolate max-w-7xl px-4 mx-auto relative">
        ...
        <div class="mt-32">
            ...
            <div class="flex flex-wrap justify-center mt-16 gap-10">
                <div class="md:w-[20rem] sm:w-[16rem] shadow-lg shadow-slate-400 rounded-sm overflow-hidden">
